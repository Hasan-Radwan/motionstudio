      ...
      tiers: [
        {
          ...
          features: ['All core templates', 'Export up to 720p', 'Local save'],
          featured: false,
        },
        {
          name: 'Pro',
          ...
          features: ['All templates', 'Export up to 8K', 'No app watermark', 'Your own watermark', 'Custom font upload', 'Add music'],
          featured: true,
        },
      ],
      ...
      tiers: [
        {
          ...
          features: ['كل القوالب الأساسية', 'تصدير حتى 720p', 'حفظ محلي'],
          featured: false,
        },
        {
          name: 'احترافي',
          ...
          features: ['كل القوالب', 'تصدير حتى 8K', 'بدون علامة مائية', 'علامتك المائية الخاصة', 'رفع خطوط مخصّصة', 'إضافة موسيقى'],
          featured: true,
        },
      ],
