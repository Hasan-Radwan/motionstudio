...
// to the real one in the browser. Returns { c } (the resolved copy object) so
// callers can wire interactivity or write <head> tags without re-looking it up.
export function buildMarkup(root, lang, doc = document) {
