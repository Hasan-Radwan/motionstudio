...
const AR = {
  ...
  'Color Palette 01': 'لوحة ألوان 01',
  'Sphere Carousel': 'كاروسيل كروي',
  'Gallery 01': 'معرض 01',
  'Color Palette 02': 'لوحة ألوان 02',
  'Color Palette 03': 'لوحة ألوان 03',
  'Color Palette 04': 'لوحة ألوان 04',
  'Label height': 'ارتفاع الشريط',
  ...
  'Edge shade': 'تظليل الأطراف',
  'Sphere 3D': 'كرة ثلاثية الأبعاد',
  Nodes: 'العقد',
  'Sphere size': 'حجم الكرة',
  'Node size': 'حجم العقدة',
  'Tilt (X)': 'الإمالة (X)',
  'Core glow': 'توهّج النواة',
  'Core color': 'لون النواة',
  'Show lines': 'إظهار الخطوط',
  'Side margin': 'الهامش الجانبي',
  'Top / bottom margin': 'هامش علوي/سفلي',
  'Code size': 'حجم الكود',
  Roundness: 'الاستدارة',
  Backdrop: 'خلفية سادة',
  'Backdrop color': 'لون الخلفية',
  'Code color': 'لون الكود',
